<%@ Page Title="" Language="C#" MasterPageFile="~/iDashboard.Master" AutoEventWireup="true" CodeBehind="PencairanProdukHaji.aspx.cs" Inherits="iDashboard.PencairanProdukHaji" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="bottom" runat="server">
    <script>
        ...
        function LoadData() {
            $.ajax({
                type: "POST",
                url: 'PencairanProdukHaji.aspx/LoadDataPencairan',
        ...
        function LoadDtMarketing() {
            ...
            $.ajax({
                type: "POST",
                url: 'PencairanProdukHaji.aspx/LoadDataTopMarketing',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
                    if (response.d != null) {
        ...
        function ActivityLoadPP() {
            ...
            jQuery.ajax({
                type: "POST",
                url: 'PencairanProdukHaji.aspx/ActivityLoad1',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
